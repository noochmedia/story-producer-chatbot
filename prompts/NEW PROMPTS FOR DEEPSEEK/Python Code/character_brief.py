...
def get_character_brief_prompt():
    """
    Provide the character_brief prompt.

    Purpose:
    This function generates the corresponding prompt content from the character_brief.

    Response Format:
    Specify structured outputs where applicable.

    Returns:
    A string containing the character_brief prompt content.
    """
    return """
