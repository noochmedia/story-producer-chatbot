...
def get_find_soundbites_prompt():
    """
    Provide the find_soundbites prompt.

    Purpose:
    This function generates the corresponding prompt content from the find_soundbites.

    Response Format:
    Specify structured outputs where applicable.

    Returns:
    A string containing the find_soundbites prompt content.
    """
    return """
